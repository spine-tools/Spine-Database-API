...
- Close database mappings in the correct thread when shutting down Spine DB Server.
- Fixed an issue when rolling back item updates.
- Other minor fixes, also in documentation.
