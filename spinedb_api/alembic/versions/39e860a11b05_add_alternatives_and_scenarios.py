...
def alter_tables_after_update():
    ...
    if "next_id" in m.tables:
        with op.batch_alter_table("next_id") as batch_op:
            ...
            batch_op.add_column(sa.Column("scenario_alternatives_id", sa.Integer, server_default=sa.null()))
        user = "alembic"
...
def downgrade():
    ...
    if "next_id" in m.tables:
        with op.batch_alter_table("next_id") as batch_op:
            ...
            batch_op.drop_column("scenario_alternatives_id")
