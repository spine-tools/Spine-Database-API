...
def create_new_spine_database(db_url, for_spine_model=False):
    ...
    if for_spine_model:
        ...
        sql = """
            ...
            (12, 0, 3, 'connection__commodity_group__commodity_group', 0, NULL),
            (12, 1, 9, 'connection__commodity_group__commodity_group', 0, NULL),
            (12, 2, 9, 'connection__commodity_group__commodity_group', 0, NULL),
