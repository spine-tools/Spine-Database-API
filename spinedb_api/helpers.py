...
def add_specifc_data_structure_for_spine_model(db_url):
    ...
    import_data(
        ...
        object_parameters=(
            ...
            ("unit", "fix_units_on"),
            ("temporal_block", "start_datetime"),
            ("temporal_block", "end_datetime"),
            ("temporal_block", "time_slice_duration"),
            ("node", "demand"),
            ("storage", "stor_state_cap"),
            ("storage", "frac_state_loss"),
        ),
        relationship_parameters=(
            ("unit__commodity", "unit_conv_cap_to_flow", 1),
            ("unit__commodity", "minimum_operating_point"),
            ("unit__commodity__direction", "unit_capacity"),
            ("unit__commodity__direction", "operating_cost"),
            ("unit__commodity__direction", "vom_cost"),
            ("commodity_group__node_group", "tax_net_flow"),
            ("commodity_group__node_group", "tax_out_flow"),
            ("commodity_group__node_group", "tax_in_flow"),
            ("unit__commodity__commodity", "fix_ratio_out_in_flow"),
            ("unit__commodity__commodity", "max_ratio_out_in_flow"),
            ("unit__commodity__commodity", "min_ratio_out_in_flow"),
            ("connection__node__direction", "fix_ratio_out_in_trans"),
            ("connection__node__direction", "max_ratio_out_in_trans"),
            ("connection__node__direction", "min_ratio_out_in_trans"),
            ...
            ("unit_group__commodity_group", "max_cum_in_flow_bound"),
            ("unit__node__direction", "fix_flow"),
            ("connection__node__direction", "fix_trans"),
        ),
    )
