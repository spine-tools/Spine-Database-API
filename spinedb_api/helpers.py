...
def add_specifc_data_structure_for_spine_model(db_url):
    ...
    object_classes = (
        ...
        ("output", "Desired output variables", 9, 280743406202948),
        ("report", "Group of output variables", 10, 281108461711708),
    ...
    import_data(
        ...
        relationship_parameters=(
            ...
            ("unit__node__direction", "unit_conv_cap_to_flow", 1),
            ("unit__node__direction", "minimum_operating_point", None),
            ("unit__node__direction", "unit_capacity", None),
            ("unit__node__direction", "operating_cost", None),
            ("unit__node__direction", "fuel_cost", None),
            ("unit__node__direction", "vom_cost", None),
            ...
            ("connection__node__direction", "fix_connection_flow", None),
            ("connection__node__direction", "connection_capacity", None),
            ("connection__node__direction", "connection_conv_cap_to_flow", 1),
