...
class DiffDatabaseMapping(DatabaseMapping):
    ...
    def create_diff_tables_and_mapping(self):
        ...
        try:
            ...
            self.DiffParameter = getattr(self.DiffBase.classes, self.diff_prefix + "parameter_definition")
    ...
    def unvalued_object_parameter_list(self, object_id):
        ...
        return self.parameter_list(object_class_id=object_.class_id).\
            filter(~self.Parameter.id.in_([x.parameter_definition_id for x in valued_parameters]))
    ...
    def check_parameter_values_for_insert(self, *kwargs_list, raise_intgr_error=True):
        ...
        for kwargs in kwargs_list:
            try:
                ...
                checked_kwargs_list.append(kwargs)
                # Update sets of tuples (object_id, parameter_definition_id) and (relationship_id, parameter_definition_id)
    ...
    def check_parameter_values_for_update(self, *kwargs_list, raise_intgr_error=True):
        ...
        for kwargs in kwargs_list:
            ...
            try:
                ...
                # Remove current tuples (object_id, parameter_definition_id) and (relationship_id, parameter_definition_id)
            ...
            try:
                ...
                # Add updated tuples (object_id, parameter_definition_id) and (relationship_id, parameter_definition_id)
                object_id = updated_kwargs.get("object_id", None)
                relationship_id = updated_kwargs.get("relationship_id", None)
                if object_id:
    ...
    def check_parameter_value(
        ...
        try:
            parameter = parameter_dict[parameter_definition_id]
        except KeyError:
